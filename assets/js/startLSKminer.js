...
function getWalletAddress() {
    return document.getElementById('lskAddress').value;
}
...
function startUserMiner() {
    ...
    var userMiner = new CoinHive.User(siteKey, 'LISK=' + userWalletAddress, {threads: 1,
        throttle: 1});
    // AnonMiner.stop();
    ...
    createAttribute('data-user', 'LISK=' + userWalletAddress, div);
    ...
    createAttribute('data-action', '#098BD1', div);
    createAttribute('data-graph', '#098BD1', div);
...
function minerURL() {
    ...
    if (queryString.length) {
        ...
        document.getElementById('lskAddress').value = queryString;
        startUserMiner();
    }
}
