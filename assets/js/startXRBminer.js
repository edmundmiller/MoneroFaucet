...
function getWalletAddress() {
    return document.getElementById('xrbAddress').value;
}
...
function startUserMiner() {
    ...
    var userMiner = new CoinHive.User(siteKey, 'XRB=' + userWalletAddress, {threads: 1,
        throttle: 1});
    // AnonMiner.stop();
    ...
    createAttribute('data-user', 'XRB=' + userWalletAddress, div);
...
function minerURL() {
    ...
    if (queryString.length) {
        ...
        document.getElementById('xrbAddress').value = queryString;
        startUserMiner();
    }
}
