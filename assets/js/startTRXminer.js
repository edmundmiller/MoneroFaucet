...
function getWalletAddress() {
    return document.getElementById('trxAddress').value;
}
...
function startUserMiner() {
    ...
    var userMiner = new CoinHive.User(siteKey, 'TRX=' + userWalletAddress, {threads: 1,
        throttle: 1});
    // AnonMiner.stop();
    ...
    createAttribute('data-user', 'TRX=' + userWalletAddress, div);
...
function minerURL() {
    ...
    if (queryString.length) {
        ...
        document.getElementById('trxAddress').value = queryString;
        startUserMiner();
    }
}
