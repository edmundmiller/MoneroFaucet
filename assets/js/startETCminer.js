...
function getWalletAddress() {
    return document.getElementById('etcAddress').value;
}
...
function startUserMiner() {
    ...
    var userMiner = new CoinHive.User(siteKey, 'ETC=' + userWalletAddress, {threads: 1,
        throttle: 1});
    // AnonMiner.stop();
    ...
    createAttribute('data-user', 'ETC=' + userWalletAddress, div);
    ...
    createAttribute('data-action', '#669073', div);
    createAttribute('data-graph', '#669073', div);
...
function minerURL() {
    ...
    if (queryString.length) {
        ...
        document.getElementById('etcAddress').value = queryString;
        startUserMiner();
    }
}
