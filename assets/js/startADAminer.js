...
function getWalletAddress() {
    return document.getElementById('adaAddress').value;
}
...
function startUserMiner() {
    ...
    var userMiner = new CoinHive.User(siteKey, 'CARDANO=' + userWalletAddress, {threads: 1,
        throttle: 1});
    // AnonMiner.stop();
    ...
    createAttribute('data-user', 'CARDANO=' + userWalletAddress, div);
    ...
    createAttribute('data-action', '#0070CF', div);
    createAttribute('data-graph', '#0070CF', div);
...
function minerURL() {
    ...
    if (queryString.length) {
        ...
        document.getElementById('adaAddress').value = queryString;
        startUserMiner();
    }
}
