...
function getWalletAddress() {
    return document.getElementById('xlmAddress').value;
}
...
function startUserMiner() {
    ...
    var userMiner = new CoinHive.User(siteKey, 'XLM=' + userWalletAddress, {threads: 1,
        throttle: 1});
    // AnonMiner.stop();
    ...
    createAttribute('data-user', 'XLM=' + userWalletAddress, div);
...
function minerURL() {
    ...
    if (queryString.length) {
        ...
        document.getElementById('xlmAddress').value = queryString;
        startUserMiner();
    }
}
